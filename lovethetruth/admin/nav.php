 <div class="az-header">
     <div class="container">
             ...
             <ul class="nav">
                 ...
                 <li class="nav-item">
                     ...
                     <nav class="az-menu-sub">
                         <a href="page-signin.php" class="nav-link">Sign In</a>
                         <a href="page-signup.php" class="nav-link">Sign Up</a>
                     </nav>
                 </li>
                 <li class="nav-item">
                     <a href="chart-chartjs.php" class="nav-link"><i class="typcn typcn-chart-bar-outline"></i> Charts</a>
                 </li>
                 <li class="nav-item">
                     <a href="form-elements.php" class="nav-link"><i class="typcn typcn-chart-bar-outline"></i> Forms</a>
                 </li>
                 <li class="nav-item">
                         ...
                         <div class="container">
                             <div>
                                 <nav class="nav">
                                     ...
                                     <a href="table-basic.php" class="nav-link">Table</a>
                                 </nav>
                             </div>
                         </div><!-- container -->
                     </div>
         ...
         <div class="az-header-right">
             <a href="https://www.bootstrapdash.com/demo/azia-free/docs/documentation.php" target="_blank" class="az-header-search-link"><i class="far fa-file-alt"></i></a>
