                            ...
                            <form method="post" class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 pt-2">
                                        <button type="submit" name="web1" class="btn btn-primary"><i class="fa fa-sync"></i> Update Information</button>
                                    </div>
                                </div>
                            </form>
                        ...
                        <div class="col-sm-12 mg-t-20 mg-b-20">
                            <div class="card">
                                ...
                                <div class="card-body">
                                   ...
                                   <br>
                                   <button type="submit" class="btn btn-primary"><i class="fa fa-sync"></i> Update Contact Information</button>
